...
namespace Backend.Services
{
    ...
    public delegate void SendWelcome(); 
    ...
    public class BankFunctions
    {
        ...
        public static void SendWelcomePackage (SendWelcome welcomePack){
            welcomePack?.Invoke();
        }
        ...
        public static void SendWine(){
            System.Console.WriteLine("Send Wine");
        }

        public static void SendChocolate(){
            System.Console.WriteLine("Send Chocolate");
        }
    }
}