...
namespace Backend
{
    public class Bank
    {
        ...
        public ObservableCollection<CurrentAccount> CurrentAccountCollection{get;set;} = new ();
        public List<CreditCard> CreditCardList{get;} = new ();

        public CurrentAccount SelectedAccount { get; set; }
        ...
        public CurrentAccount CreateCurrentAccount(){
            ...
            CurrentAccountCollection.Add(c);
            return c;
        }

        public void DeleteCurrentAccount(CurrentAccount ca){
            if(ca != null){
                CurrentAccountCollection.Remove(ca);
                CurrentAccountList.Remove(ca);
            }
        }
